...
def q3_prep():
	...
	# Move into question 3 directory
	os.chdir('./Q3_results')
	...
	# Get the oddballs ready ('Years certified' and 'Years supervisor') -- converts numbers to categories
...
def question3(df, demo_lst, bx_lst, plot):
	...
	for demo in demo_lst:
		...
		for bx in bx_lst:
			...
			#if plot == 'regular':
			if (bx != 'Credentialing requirements' and bx != 'Training and supervision'):
				_ = plt.tight_layout()
